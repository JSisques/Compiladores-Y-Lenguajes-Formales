...
#endif
/* Tokens.  */
#define ELEMENT_START 258
#define ELEMENT_END 259
...
{
       9,     0,    -1,    10,    -1,     3,    11,     4,    12,     3,
       4,    -1,    -1,    11,     5,     7,     6,    -1,    10,    -1,
       6,    -1
};
...
{
  "$end", "error", "$undefined", "ELEMENT_START", "ELEMENT_END",
  "ATTRIBUTE", "VALUE", "'='", "$accept", "document", "element",
  "attributes", "element_content", 0
};
#endif
